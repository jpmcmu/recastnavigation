...
struct dtNavMeshCreateParams
{
	...
	const dtFloat* detailVerts;				///< The detail mesh vertices. [Size: 3 * #detailVertsCount] [Unit: wu]
	...
	const dtFloat* offMeshConVerts;
	/// Off-mesh connection radii. [Size: #offMeshConCount] [Unit: wu]
	const dtFloat* offMeshConRad;
	...
	dtFloat bmin[3];			///< The minimum bounds of the tile. [(x, y, z)] [Unit: wu]
	dtFloat bmax[3];			///< The maximum bounds of the tile. [(x, y, z)] [Unit: wu]

	/// @}
	/// @name General Configuration Attributes
	/// @{

	dtFloat walkableHeight;	///< The agent height. [Unit: wu]
	dtFloat walkableRadius;	///< The agent radius. [Unit: wu]
	dtFloat walkableClimb;	///< The agent maximum traversable ledge. (Up/Down) [Unit: wu]
	dtFloat cs;				///< The xz-plane cell size of the polygon mesh. [Limit: > 0] [Unit: wu]
	dtFloat ch;				///< The y-axis cell height of the polygon mesh. [Limit: > 0] [Unit: wu]
